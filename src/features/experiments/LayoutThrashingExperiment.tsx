...
export function LayoutThrashingExperiment() {
  ...
  return (
    <GeistCard className="bg-white border border-neutral-200 p-5 space-y-6 font-sans">
      ...
      {/* 2. DOM Read/Write 연산 스펙 */}
      <div className="space-y-3 font-mono text-sm">
        <div className="flex items-center justify-between border-b border-neutral-100 pb-2">
          <span className="text-sm font-bold text-black">DOM Read/Write 연산 스펙</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
          ...
          >
            <div className="flex items-center justify-between border-b border-neutral-200/50 pb-1.5">
              ...
              <span className="text-xs font-bold text-neutral-600 truncate">Forced Reflow</span>
            </div>
            <div className="text-xs text-neutral-800 space-y-1.5 break-words">
              <div>
                <span className="font-bold text-neutral-900">offsetHeight:</span> 루프 내부 교대
                실행
              </div>
              <div>
                <span className="font-bold text-neutral-900">리플로우:</span> 매 프레임 50회 동기
                리플로우
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center justify-between border-b border-neutral-200/50 pb-1.5">
              ...
              <span className="text-xs font-bold text-blue-900 truncate">Batched Execution</span>
            </div>
            <div className="text-xs text-neutral-800 space-y-1.5 break-words">
              <div>
                <span className="font-bold text-neutral-900">offsetHeight:</span> Read 파트 전량
                수집
              </div>
              <div>
                <span className="font-bold text-neutral-900">리플로우:</span> 1회 렌더링 묶음 반영
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="p-3.5 bg-neutral-50 rounded-lg text-sm text-black font-medium leading-relaxed font-sans break-words border-t border-neutral-100 pt-5">
        ...
        안에서 번갈아 실행하면 브라우저가 강제로 레이아웃(Layout)을 재계산합니다. Read를 먼저 다 한
        후 Write를 모아서 하면 렌더링 프레임 끊김이 사라집니다.
      </div>
    </GeistCard>
  );
}
