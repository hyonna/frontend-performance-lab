          ...
          <span className="flex items-center space-x-2">
            ...
            >
              ...
              <text
                ...
                fontWeight="900"
                fontSize="20"
                fill={pathname === '/' ? '#000000' : '#FFFFFF'}
              >
                P
              </text>
              <path
                d="M21 5L15 17H20L18 27L27 13H21L23 5Z"
                fill="#1e3a8a"
                stroke="#60a5fa"
                strokeWidth="0.8"
              />
            ...
            {EXPERIMENTS_DATA.map((exp) => {
              ...
              return (
                <Link
                  key={exp.id}
                  href={href}
                  className={`group flex items-center justify-between px-3 py-2.5 rounded-md !text-[14px] transition ${
                    isActive
                      ? 'bg-black text-white font-bold shadow-sm'
                      : 'text-black font-medium hover:bg-neutral-100'
                  }`}
                >
                  <div className="flex items-center space-x-2.5 truncate">
                    <span
                      className={`!text-[14px] font-mono px-2 py-0.5 rounded ${
                        isActive
                    ...
                    <span className="truncate !text-[14px]">{exp.titleKo}</span>
                  </div>
                  <ChevronRight
